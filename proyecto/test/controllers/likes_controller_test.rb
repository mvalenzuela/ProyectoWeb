...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { document_id: @like.document_id, user_id: @like.user_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { document_id: @like.document_id, user_id: @like.user_id } }
